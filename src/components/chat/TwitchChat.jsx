 ...
 // Sistema de respaldo priorizando APIs abiertas estables para evitar el 404 de Twitch
const BADGE_SOURCES = {
  platform: [
  ...
  sub: [
    ...
    'https://static-cdn.jtvnw.net/badges/v1/5d1155e3-0e3b-4771-8899-6ac858d6e6e8/1'
  ],
  turbo: [
